...
*AdminUsersControllerApi* | [**create_user**](docs/AdminUsersControllerApi.md#create_user) | **POST** /api/v1/admin/users | create a user
*AdminUsersControllerApi* | [**delete_user**](docs/AdminUsersControllerApi.md#delete_user) | **DELETE** /api/v1/admin/users/{id} | delete a user
*AdminUsersControllerApi* | [**get_user**](docs/AdminUsersControllerApi.md#get_user) | **GET** /api/v1/admin/users/{id} | show details of a user
*AdminUsersControllerApi* | [**get_users**](docs/AdminUsersControllerApi.md#get_users) | **GET** /api/v1/admin/users | List users
*AdminUsersControllerApi* | [**update_user**](docs/AdminUsersControllerApi.md#update_user) | **PUT** /api/v1/admin/users/{id} | update a user
...
*InternalApiApi* | [**internal_create_inference**](docs/InternalApiApi.md#internal_create_inference) | **POST** /api/v1/internal/inference | 
*InternalApiApi* | [**internal_update_file**](docs/InternalApiApi.md#internal_update_file) | **PATCH** /api/v1/internal/file/{customerName}/{objectKey} | 
...
*PlaylistApi* | [**curate_playlist**](docs/PlaylistApi.md#curate_playlist) | **POST** /api/v1/playlist/{methodName} | Curate playlist.
...
## Documentation For Models
 ...
 - [AdminApiCreateUserDTO](docs/AdminApiCreateUserDTO.md)
 - [AdminApiUpdateUserDTO](docs/AdminApiUpdateUserDTO.md)
 ...
 - [CuratePlaylistDTO](docs/CuratePlaylistDTO.md)
 - [CuratePlaylistResponseDTO](docs/CuratePlaylistResponseDTO.md)
 - [DominantColor](docs/DominantColor.md)
 - [Emotion](docs/Emotion.md)
 - [ErrorResponse](docs/ErrorResponse.md)
 - [EyeDirection](docs/EyeDirection.md)
 - [EyeOpen](docs/EyeOpen.md)
 - [Eyeglasses](docs/Eyeglasses.md)
 - [FaceDetail](docs/FaceDetail.md)
 - [FaceDetection](docs/FaceDetection.md)
 - [FaceOccluded](docs/FaceOccluded.md)
 ...
 - [Label](docs/Label.md)
 - [LabelAlias](docs/LabelAlias.md)
 - [LabelCategory](docs/LabelCategory.md)
 - [LabelDetection](docs/LabelDetection.md)
 - [Landmark](docs/Landmark.md)
 - [LoginDTO](docs/LoginDTO.md)
 - [MouthOpen](docs/MouthOpen.md)
 ...
 - [SaveFileDTO](docs/SaveFileDTO.md)
